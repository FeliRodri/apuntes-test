...
// --- 1. Configuración de Metadatos y UI (Alta Cohesión) ---
...
// --- 2. Configuración de Rutas / Navegación (SRP) ---
const starlightSidebar = [
  {
    label: "Inicio",
    items: [{ label: "Guía de Uso", slug: "guia" }],
  },
  {
    label: "Clases",
...
// --- 3. Orquestador Principal (Bajo Acoplamiento) ---
      ...
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/FeliRodri/apuntes-test",
        },
      ],
